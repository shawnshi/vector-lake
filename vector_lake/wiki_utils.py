...
import yaml
try:
    # ⚡ Bolt: Fast YAML parsing via C-extensions when available (approx 8x-10x faster)
...
def split_frontmatter(content: str) -> tuple[dict, str]:
    ...
    try:
        # ⚡ Bolt: Use specific SafeLoader for fast loading
...
def write_markdown_file(path: str | Path, frontmatter: dict, body: str):
    ...
    # ⚡ Bolt: Use specific Dumper for fast serialization
