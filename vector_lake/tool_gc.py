...
# Moved to gc_receipts; re-imported so the code below keeps working.
from vector_lake.gc_receipts import (
    _GC_RECEIPT_CONTRACT,
    _ORPHAN_FINGERPRINT_PREFIX,
    _hash_file,
    _plain_path_stat,
    _read_stable_utf8_file,
